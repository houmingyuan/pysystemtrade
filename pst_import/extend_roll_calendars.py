...
Usage:
    python pst_import/extend_roll_calendars.py --detect
    python pst_import/extend_roll_calendars.py --extend
    python pst_import/extend_roll_calendars.py --extend --instrument HEATOIL
"""
...
def rebuild_prices(instrument_code: str, quiet: bool = False) -> bool:
    ...
    try:
        from pst_import.build_multiple_prices import process_single_instrument as build_multiple
        from pst_import.build_adjusted_prices import process_single_instrument as build_adjusted
...
def main() -> int:
    ...
    if args.detect:
        ...
        print(f"\nTo extend these, run:")
        print(f"  python pst_import/extend_roll_calendars.py --extend")
        return 0
