...
Usage:
    ...
    python sysinit/futures/fix_roll_calendars.py --detect

    # Detect broken roll calendars
    python sysinit/futures/fix_roll_calendars.py --detect-broken

    # Fix all truncated
    python sysinit/futures/fix_roll_calendars.py --fix

    # Fix specific instruments
    python sysinit/futures/fix_roll_calendars.py --fix --instruments EUROSTX BUND CAC

    # Quiet mode for scripting
    python sysinit/futures/fix_roll_calendars.py --fix --quiet
"""
