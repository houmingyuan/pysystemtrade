...
Usage:
    python sysinit/futures/extend_roll_calendars.py --detect
    python sysinit/futures/extend_roll_calendars.py --extend
    python sysinit/futures/extend_roll_calendars.py --extend --instrument HEATOIL
"""
